...
# top-l
plot(houseSub$DateTime,houseSub$Global_active_power,xlab="", 
     ylab ="Gobal Active Power (kilowatts)", type = "l")
# top-r
plot(houseSub$DateTime,houseSub$Voltage, 
     xlab="datetime", 
     ylab ="Voltage", 
     col = "black",
     type = "l")
...
legend("topright", 
       ...
       lwd = 1)
plot(houseSub$DateTime,houseSub$Global_reactive_power, 
     xlab="datetime", 
     ylab ="Voltage", 
     col = "black",
     type = "l")
